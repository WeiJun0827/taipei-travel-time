...
CREATE TABLE `bus_route` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `route_id_UNIQUE` (`route_id`,`direction`)
...
CREATE TABLE `bus_travel_time` (
  ...
  PRIMARY KEY (`id`),
  KEY `bus_travel_time_ibfk_1` (`route_id`),
  KEY `bus_travel_time_ibfk_2` (`from_stop_id`),
  KEY `bus_travel_time_ibfk_3` (`to_stop_id`),
  CONSTRAINT `bus_travel_time_ibfk_1` FOREIGN KEY (`route_id`,`direction`) REFERENCES `bus_route` (`route_id`,`direction`),
